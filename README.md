...
### Современный дизайн
- **Цветовая схема**: Черно-белая основа с яркими акцентами (оранжевый, синий, зеленый, фиолетовый)
- **Анимированные кнопки**: Красивые переходы и эффекты при наведении
...
- **Регистрация**: `/login/` - страница входа и регистрации
...
- **Celery интеграция**: Фоновые задачи и планировщик
- **Redis кэширование**: Быстрый доступ к данным
- **Линтинг кода**: Flake8 и Black для качества кода
- **Production-ready**: Gunicorn для стабильной работы
...
### Сервер
- **IP адрес**: 158.160.158.67
- **Домен**: studing-place.ru
- **Статус**: Активно работает

### GitHub Actions
- **Автоматический деплой**: При push в ветки `32_2` и `develop_35.2`
- **Тестирование**: PostgreSQL + линтинг + тесты
- **Docker сборка**: Автоматическая сборка и деплой образов

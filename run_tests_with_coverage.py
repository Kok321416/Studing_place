...
if __name__ == "__main__":
    ...
    try:
        ...
        report_result = subprocess.run(report_cmd, check=True, capture_output=True, text=True)
        ...
        print("Ошибка: coverage не установлен. Установите его командой: pip install coverage")
        sys.exit(1)
